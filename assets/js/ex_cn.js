...
function Sum_number()
{
    ...
    var am_recieve = parseFloat(document.getElementById('am_recieve').value.replace(/,/g, ''));
    ...
    var ex_amount_old = parseFloat(ex_total) + parseFloat(ex_total1) + parseFloat(ex_total2) + parseFloat(ex_total3) + parseFloat(ex_total4) + parseFloat(ex_total5)
             + parseFloat(ex_total6) + parseFloat(ex_total7) + parseFloat(ex_total8) + parseFloat(ex_total9) + parseFloat(ex_total10) + parseFloat(ex_total11)
              + parseFloat(ex_total12) + parseFloat(ex_total13);

    var ex_amount_dff = parseFloat(ex_amount_old) - parseFloat(am_recieve);
    ...
    document.getElementById('ex_amount_old').value = addCommas(ex_amount_old.toFixed(2)).replace(/\d(?=(\d{15})+\.)/g, '$&,');
    document.getElementById('ex_amount_dff').value = addCommas(ex_amount_dff.toFixed(2)).replace(/\d(?=(\d{15})+\.)/g, '$&,');
