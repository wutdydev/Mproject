...
$(function () {
    $("#datetimepicker1,#datetimepicker2,#datetimepicker3,#datetimepicker4,#datetimepicker5,#datetimepicker6,\n\
#datetimepicker7,#datetimepicker8,#datetimepicker9,#datetimepicker10").datepicker({
        dateFormat: "Y-m-d",
        todayHighlight: true,
        autoclose: true
    });
