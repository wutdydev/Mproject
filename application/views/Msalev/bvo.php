                    ...
                    <div class="panel-body">
                                    ...
                                    <tr>
                                        <td width="14%">
                                            <div class="form-group">
                                                <input class="form-control css-require" value="<?php echo $query[0]['tb1_ex_date_num'] ?>" type="date" name="date_bvr" id="date_bvr">
                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                            </div>
                                        </td>
                                        <td width="12%">
                                                <input class="form-control" value="<?php echo $query[0]['tb1_ex_date_check'] ?>" type="date" name="ex_date_check" id="ex_date_check">
                                        </td>
                                        ...
                                        <td width="11%">
                                            <div class="form-group">
                                                <input class="form-control css-require" value="<?php echo $book ?>" type="text" name="book_number" id="book_number" placeholder="เลขที่ใบกำกับภาษี">
                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                            </div>
                                        </td>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    <tr>
                                        <td width="18%">
                                            <div class="form-group">
                                                <input class="form-control css-require" value="<?php echo $query[0]['tb1_ex_jobmiw'] ?>" type="text" name="JOBMIW" id="JOBMIW" placeholder="เลขที่ใบเสนอราคา">
           
                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                            </div>
                                                <input class="form-control" value="<?php echo $query[0]['tb1_ex_company'] ?>" type="hidden" name="cid" id="cid">
                                                <input class="form-control" value="<?php echo $query[0]['tb1_ex_main_code'] ?>" type="hidden" name="main_code" id="main_code" >
                                        </td>
                                        <td width="16%"><input class="form-control" type="text" value="<?php echo $query[0]['tb2_cus_name'] ?>" name="cus_name" id="cus_name" placeholder="ชื่อลูกค้า">
                        ...
                        <div class="form-group has-feedback" style="width:500px;">     
                            <div class="form-control css-require">
                                <label><input type="radio" id='save' name='save'  value="ออกเต็ม"  <?php echo $query[0]['tb1_ex_detail'] === "ออกเต็ม" ? "checked" : ""; ?>> ออกเต็ม</label>
                                &nbsp;&nbsp;
                                <label><input type="radio" id='save' name='save'  value="ออกครั้งแรก"  <?php echo $query[0]['tb1_ex_detail'] === "ออกครั้งแรก" ? "checked" : ""; ?>> ออกครั้งแรก</label>
                                &nbsp;&nbsp;
                                <label><input type="radio" id='save' name='save'  value="ออกครั้งที่สอง"  <?php echo $query[0]['tb1_ex_detail'] === "ออกครั้งที่สอง" ? "checked" : ""; ?>> ออกครั้งที่สอง</label>
                            </div>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>
                        <br>
