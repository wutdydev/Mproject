...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(".inputa").change(function () {
            var keym = $.inArray($("#cus_province").val(), ['กรุงเทพมหานคร', 'กรุงเทพฯ', 'กทม', 'กทม.', 'กรุงเทพ']);

            if ($("input[id='cus_prefix']:checked").val() == 1) {

                if (keym !== -1) { //ถ้ากรอกเข้ามาแล้ววไม่ใช่ ก ท ม

                    var sub_district = "แขวง";
                    var district = "เขต";
                    var province = "";

                    if ($("input[id='cus_type_address']:checked").val() == 2) {
                        var Lane = "ซ.";
                        var Road = "ถ.";
            ...
            $("#cus_address_ex").val($.trim(addspace("", $("#cus_number").val()) + addspace("หมู่ที่ ", $("#cus_swine").val()) + addspace("", $("#cus_building").val()) + addspace("ห้องเลขที่ ", $("#cus_room").val())
                    + addspace("ชั้นที่ ", $("#cus_floor").val()) + addspace(Lane, $("#cus_alley").val()) + addspace(Road, $("#cus_road").val()) + addspace(sub_district, $("#cus_sub_district").val())
                    + addspace(district, $("#cus_district").val()) + addspace(province, $("#cus_province").val()) + addspace("", $("#cus_zipcode").val())
                ...
                <label><input type="radio" name="myradio" value="2"  />444</label>-->
                            ...
                            <div class="col-lg-6">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>เลขที่</td>
                                        <td><input class="form-control inputa" type="text" id="cus_number" name="cus_number" value="<?php echo $query_cus[0]['cus_number']; ?>"  placeholder="ไม่ต้องกรอกคำว่า บ้านเลขที่/เลขที่"></td>
                                    </tr>

                                    <tr>
                                        <td>หมู่ที่</td>
                                        <td><input class="form-control inputa" type="text" id="cus_swine" name="cus_swine"  value="<?php echo $query_cus[0]['cus_swine']; ?>" placeholder="ไม่ต้องกรอกคำว่า หมู่ที่"></td>
                                    </tr> 
                                    <tr>
                                        <td>หมู่บ้าน/อาคาร</td>
                                        <td>
                                            <input class="form-control inputa" type="text" id="cus_building" name="cus_building" value="<?php echo $query_cus[0]['cus_building']; ?>"  placeholder="กรุณาระบุคำนำหน้าของ หมู่บ้าน/อาคาร เช่น อาคารชำนาญ">

                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="20%">ห้องเลขที่</td>
                                        <td><input class="form-control inputa" type="text" id="cus_room" name="cus_room" value="<?php echo $query_cus[0]['cus_room']; ?>"  placeholder="ไม่ต้องกรอกคำว่า เลขที่ห้อง"></td>
                                    </tr>
                                    <tr>
                                        <td>ชั้นที่</td>
                                        <td><input class="form-control inputa" type="text" id="cus_floor" name="cus_floor"  value="<?php echo $query_cus[0]['cus_floor']; ?>" placeholder="ไม่ต้องกรอกคำว่า ชั้น"></td>
                                    </tr>

                                    <tr>
                                        <td>ซอย</td>
                                        <td><input class="form-control inputa" type="text" id="cus_alley" name="cus_alley"  value="<?php echo $query_cus[0]['cus_alley']; ?>" placeholder="ไม่ต้องกรอกคำว่า ซอย"></td>
                                    </tr> 

                                    <tr>
                                        <td>ถนน</td>
                                        <td><input class="form-control inputa" type="text" id="cus_road" name="cus_road"  value="<?php echo $query_cus[0]['cus_road']; ?>" placeholder="ไม่ต้องกรอกคำว่า ถนน"></td>
                                    </tr> 
                                    <tr>
                                        <td>ตำบล / แขวง</td>
                                        <td><input id="cus_sub_district" name="cus_sub_district" class="form-control inputa" type="text" value="<?php echo $query_cus[0]['cus_sub_district']; ?>" placeholder="ไม่ต้องกรอกคำว่า ตำบล/เขต"></td>
                                    </tr>
                                    <tr>
                                        <td>อำเภอ / เขต</td>
                                        <td><input id="cus_district" name="cus_district"  class="form-control inputa" type="text" value="<?php echo $query_cus[0]['cus_district']; ?>" placeholder="ไม่ต้องกรอกคำว่า อำเภอ/แขวง"></td>
                                    </tr>
                                    <tr>
                                        <td>จังหวัด</td>
                                        <td><input id="cus_province" name="cus_province" class="form-control inputa" type="text" value="<?php echo $query_cus[0]['cus_province']; ?>" placeholder="ไม่ต้องกรอกคำว่า จังหวัด"></td>
                                    </tr>
                                    <tr>
                                        <td>รหัสไปรษณีย์</td>
                                        <td><input id="cus_zipcode" name="cus_zipcode" class="form-control inputa"  type="text" value="<?php echo $query_cus[0]['cus_zipcode']; ?>" placeholder="ไม่ต้องกรอกคำว่า เลขที่รหัสไปรษณีย์"></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group has-feedback" style="width:200px;">     
                                                <div class="form-control css-require inputa">
                        ...
                        <table align="center" class="table table-bordered" width="100%" >
                            <th width="15%">ตัวอย่างที่อยู่ (สามารถแก้ไขเพิ่มได้)</th>
                            <tr>
                                <td>
                                    <textarea class="form-control" id="cus_address_ex" name="cus_address_ex" rows="5"><?php echo htmlspecialchars($query_cus[0]['cus_address']); ?></textarea>
                                </td>
                            </tr>
                        </table>
