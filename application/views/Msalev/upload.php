                            ...
                            <tbody>
                                ...
                                foreach ($query_upload as $res) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" data-toggle="tooltip" data-placement="top" title="ลบข้อมูล"  class="btn btn-outline btn-danger confirmation" href="<?php echo base_url('Salev/Maindata/Upload/Delete') . '/' . $res->tb1_up_id ?>"><i class="fa fa-trash-o" ></i></button>
                                        </td>
                                    </tr>
                                    <?php
                                }
