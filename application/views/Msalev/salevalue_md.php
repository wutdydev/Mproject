                ...
                foreach ($query as $res) {
                    ...
                    <tr>
                        ...
                        <td align='left'>
                            ...
                            <?php
                            if ($res->tb1_md_approved == 0 and $res->tb9_count_data_id >= 1) {
                                ?>
                                <button type="button" class="btn btn-outline btn-success btn-sm confirmation" data-placement="top" title="อนุมัติ" href="<?php echo base_url('Salev/Maindata/PApprove') . '/' . $res->tb1_data_id ?>"><i class="fa fa-check-circle" ></i> อนุมัติ</button> 
                                <?php
                            } else if($res->tb1_md_approved == 1){
                                ?>
                                <button type="button" class="btn btn-outline btn-danger btn-sm confirmation2" data-placement="top" title="ยกเลิกอนุมัติ" href="<?php echo base_url('Salev/Maindata/PApprove') . '/' . $res->tb1_data_id ?>"><i class="fa fa-rotate-right" ></i> ยกเลิกอนุมัติ</button> 
                                <?php
                            }else{
                            }
                            ?>
