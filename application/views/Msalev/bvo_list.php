            ...
            <table width='100%' class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                foreach ($query as $res) {
                    ...
                    <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-outline btn-primary btn-sm" data-placement="top" title="ออกอีกครั้ง" onclick="window.open('<?php echo base_url('Salev/BVO/'.$type.'/Preview') . '/' . $res->tb1_ex_id ?>')"><i class="fa fa-file-pdf-o" ></i> P</button>
