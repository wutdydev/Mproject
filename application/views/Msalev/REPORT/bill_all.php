        ...
        <table align="center" class="table table-bordered" width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
            <thead>
                <tr align="center" bgcolor="#F5F5F5">
                    ...
                    <th style="border-top:solid 0.5px #000; border-right:solid 0.5px #000;border-bottom:solid 0.5px #000;font-size: 1.4rem;" align="center" rowspan="2">BILL</th>
                    <th style="border-top:solid 0.5px #000; border-right:solid 0.5px #000;border-bottom:solid 0.5px #000;font-size: 1.4rem;" align="center" rowspan="2">VAT</th>
            ...
            foreach ($query as $res) {
                ...
                <tr>
                    ...
                    <td align="center" style="border-right:solid 0.5px #000;border-bottom:solid 0.5px #000;font-size: 1.4rem;"><?php echo $res->tb3_cus_name; ?></td>
                    ...
                    <td align="center" style="border-right:solid 0.5px #000;border-bottom:solid 0.5px #000;font-size: 1.4rem;"><?php echo check_bv($res->tb9_ex_num_true,$res->tb9c_ex_id,$res->tb9_ex_total_amount,$res->tb2_am_recieve) ?></td>
                    <td align="center" style="border-right:solid 0.5px #000;border-bottom:solid 0.5px #000;font-size: 1.4rem;"><?php echo check_bv($res->tb10_ex_num_true,$res->tb10c_ex_id,$res->tb10_ex_total_amount,$res->tb2_am_recieve) ?></td>
