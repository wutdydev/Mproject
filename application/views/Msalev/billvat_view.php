                                        ...
                                        <table class="table table-striped table-bordered table-hover">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width='15%'><input type="text" style="text-align: right" class="form-control" name="ex_total" id="ex_total" value="<?php echo empt_fm2($ex_total) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total1" id="ex_total1" value="<?php echo empt_fm2($ex_total1) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total2" id="ex_total2" value="<?php echo empt_fm2($ex_total2) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="ex_cost3" id="ex_cost3" onKeyUp="Sum_number();FormatCurrency(this);" onBlur="checkValue(this, this.defaultValue)"  onkeypress="return CheckNumeric()" value="<?php echo empt_fm($ex_cost3) ?>"></td> 
                                                     <td><input type="text" style="text-align: right" class="form-control" name="ex_total3" id="ex_total3" value="<?php echo empt_fm2($ex_total3) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total4" id="ex_total4" value="<?php echo empt_fm2($ex_total4) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total5" id="ex_total5" value="<?php echo empt_fm2($ex_total5) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total6" id="ex_total6" value="<?php echo empt_fm2($ex_total6) ?>" readonly></td> 
                                                </tr>
                                                 <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total7" id="ex_total7" value="<?php echo empt_fm2($ex_total7) ?>" readonly></td> 
                                                </tr>
                                                         <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total8" id="ex_total8" value="<?php echo empt_fm2($ex_total8) ?>" readonly></td> 
                                                </tr>
                                                         <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total9" id="ex_total9" value="<?php echo empt_fm2($ex_total9) ?>" readonly></td> 
                                                </tr>
                                                         <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total10" id="ex_total10" value="<?php echo empt_fm2($ex_total10) ?>" readonly></td> 
                                                </tr>
                                                         <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total11" id="ex_total11" value="<?php echo empt_fm2($ex_total11) ?>" readonly></td> 
                                                </tr>
                                                         <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total12" id="ex_total12" value="<?php echo empt_fm2($ex_total12) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><input type="text" style="text-align: right" class="form-control" name="ex_total13" id="ex_total13" value="<?php echo empt_fm2($ex_total13) ?>" readonly></td> 
                                                </tr>
                                                <tr>
                                                    <td></td> 
                                                    <td></td>
