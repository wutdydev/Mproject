...
<script src="<?php echo base_url() ?>assets/js/auto_order2.js"  type="text/javascript"></script>
...
<script type="text/javascript">
    ...
    $('.confirmation3').confirm({
        ...
        animateFromElement: false,
        icon: 'glyphicon glyphicon-exclamation-sign',
        content: 'หากยกเลิกแล้วจะต้องทำการรับเข้าระบบอีก',
        title: 'ต้องยกเลิกรับเข้าระบบหรือไม่',
        autoClose: 'cancel|6000',
        type: 'red',
        confirmButtonColor: "#DD6B55",
